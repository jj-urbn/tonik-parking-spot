  ...
  return (
    <BookingsProvider>
      <div className="grid h-full grid-cols-[302px_1fr_302px] grid-rows-[196px_1fr]">
        ...
        <div className="col-start-1 row-start-1 flex flex-col justify-between border-r border-b border-border px-8 py-12">
          <p className="text-xs text-default">Tonikowy parking</p>
          <svg className="shrink-0 fill-strong" width="48" height="48" viewBox="0 0 48 48" aria-hidden>
